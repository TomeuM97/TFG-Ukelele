...
class PlayerBackgroundView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //Paint note play mark
        brush.color = colorPrimary
        brush.strokeWidth = 50F
        canvas.drawLine((canvas.width*0.10).toFloat(),canvas.height.toFloat(),(canvas.width*0.90).toFloat(),canvas.height.toFloat(),brush)
